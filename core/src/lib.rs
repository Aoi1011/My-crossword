...
/// Utilizes to manipulate the secp256k1 curve parameters
pub mod util {
    ...
    pub use crate::{
        ecmult::{
            odd_multiple_table, ECMULT_TABLE_SIZE_A, ECMULT_TABLE_SIZE_G, WINDOW_A, WINDOW_G,
        },
